      ...
      <div style={S.body}>
        ...
        {!isConnected ? (
          <div style={S.emptyState}>
            ...
            <div>
              <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.7)' }}>
                Connect your wallet
              </p>
              <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 12, color: 'rgba(255,255,255,0.35)', marginTop: 4 }}>
            ...
            <div>
              ...
              <div style={{ ...S.row, borderBottom: 'none' }}>
                ...
                <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                  ...
                  <span style={{ fontFamily: "'Exo 2', sans-serif", fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>CYCLE</span>
                </span>
              </div>
            </div>
